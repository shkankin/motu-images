...
function renderMain() {
    ...
    <div class="header-row">
      <div class="logo-group">
        ...
        <div>
          ...
          <div class="logo-subtitle text-dim text-upper">${stats.total} Figures · ${stats.owned} Owned · <span class="text-gold">v6.18</span>${S.syncTs ? ' · '+new Date(S.syncTs).toLocaleDateString() : ''}</div>
        </div>
      </div>
  ...
  if (ca) {
    ...
    // v6.18: also expose this so user interactions (status taps, long-press
    ...
    // v6.18: bump the idle-show timer on user interactions other than scroll.

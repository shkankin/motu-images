    ...
    <div class="header-row">
      <div class="logo-group">
        ...
        <div>
          ...
          <div class="logo-subtitle text-dim text-upper">${stats.total} Figures · ${stats.owned} Owned · <span class="text-gold" style="text-transform:none">v7.01</span></div>
        </div>
      </div>
...
function renderLinesGrid() {
  ...
  let html = '';
  if (!S.onboarded) {
    // v7.01: show the tour button on every render so users who skipped

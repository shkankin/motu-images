    ...
    <div class="header-row">
      <div class="logo-group">
        ...
        <div>
          ...
          <div class="logo-subtitle text-dim text-upper">${stats.total} Figures · ${stats.owned} Owned · <span class="text-gold">v6.22</span>${S.syncTs ? ' · '+new Date(S.syncTs).toLocaleDateString() : ''}</div>
        </div>
      </div>

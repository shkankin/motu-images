    ...
    <div class="header-row">
      <div class="logo-group">
        ...
        <div>
          ...
          <div class="logo-subtitle text-dim text-upper">${stats.total} Figures · ${stats.owned} Owned · <span class="text-gold" style="text-transform:none">v6.80</span></div>
        </div>
      </div>
